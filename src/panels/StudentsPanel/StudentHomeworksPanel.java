 ...
 * @author LENOVO
 */
public class StudentHomeworksPanel extends javax.swing.JPanel implements DisposeInterface{

    /**
     * Creates new form HomeworksPanel
     */
    public StudentHomeworksPanel() {
        initComponents();
        ...
        for(int i = 0; i < faker.number().numberBetween(1, 10);i++){
            StudentBoxHomeworkPanel boxHomeworkPanel = new StudentBoxHomeworkPanel(i);
