...
import panels.GeneralPanels.GeneralChatsPanel;
import panels.GeneralPanels.GeneralMusicPanel;
import panels.GeneralPanels.GeneralEditProfilePanel;
import panels.GeneralPanels.GeneralDatesPanel;
import panels.GeneralPanels.GeneralInfoProfilePanel;
import panels.GeneralPanels.GeneralAboutPanel;
import panels.GeneralPanels.GeneralNoticesPanel;
...
import panels.GeneralPanels.GeneralConfigurationPanel;

/**
 *
 * @author LENOVO
 */
public class StudentDashboardPanel extends javax.swing.JPanel implements ColorInterface, DisposeInterface{

    private static Image userImage;
    
    private GeneralChatsPanel chatsPanel;
    private GeneralAboutPanel aboutPanel;
    private static GeneralInfoProfilePanel infoProfilePanel;
    private GeneralEditProfilePanel editProfilePanel;
    ...
    public StudentDashboardPanel() {
        ...
        try {
            ...
            infoProfilePanel = new GeneralInfoProfilePanel();
            jPanelInformacion.add("infoProfilePanel",infoProfilePanel);
            
            editProfilePanel = new GeneralEditProfilePanel();
            ...
            homeworksPanel = new StudentHomeworksPanel();
            ...
            chatsPanel = new GeneralChatsPanel();
            jPanelInformacion.add("chatsPanel",chatsPanel);
            
            
            aboutPanel = new GeneralAboutPanel();
            ...
            Logger.getLogger(StudentDashboardPanel.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButtonFechasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonFechasMouseClicked
        // TODO add your handling code here:
        if(SwingUtilities.isLeftMouseButton(evt)){
            StudentDashboardPanel.showView("datesPanel");
        }
    ...
    private void jButtonAvisosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonAvisosMouseClicked
        // TODO add your handling code here:
        if(SwingUtilities.isLeftMouseButton(evt)){
            StudentDashboardPanel.showView("noticesPanel");
        }
    ...
    private void jButtonChatsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonChatsMouseClicked
        // TODO add your handling code here:
        if(SwingUtilities.isLeftMouseButton(evt)){
            StudentDashboardPanel.showView("chatsPanel");
        }
    ...
    private void jButtonMusicaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonMusicaMouseClicked
        // TODO add your handling code here:
        if(SwingUtilities.isLeftMouseButton(evt)){
            StudentDashboardPanel.showView("musicPanel");
        }
    ...
    private void jButtonAcercaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonAcercaMouseClicked
        // TODO add your handling code here:
        if(SwingUtilities.isLeftMouseButton(evt)){
            StudentDashboardPanel.showView("aboutPanel");
        }
    ...
    private void jButtonAjustesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonAjustesMouseClicked
        // TODO add your handling code here:
        if(SwingUtilities.isLeftMouseButton(evt)){
            StudentDashboardPanel.showView("configurationPanel");
        }
