...
import panels.GeneralPanels.GeneralBoxChatPanel;

/**
 *
 * @author LENOVO
 */
public class StudentBoxHomeworkPanel extends javax.swing.JPanel implements ColorInterface{

    private Color firstColor, secondColor,thirdColor,fontColor, secondFontColor, thirdFontColor;
    private int id;
    private StudentHomeworkPanel homeworkPanel;
    
    /**
     * Creates new form BoxHomeworkPanel
     */
    public StudentBoxHomeworkPanel(int _id) {
        initComponents();
         try {
            ...
            setColors(getImage);
            homeworkPanel = new StudentHomeworkPanel(jLabelNombreTarea.getText(),firstColor,secondColor,thirdColor,fontColor,secondFontColor,thirdFontColor);
            StudentDashboardPanel.addView(homeworkPanel,"homework_"+_id);
            getImage.flush();
            homeworkImage.flush();
            homeworkImage = null;
            getImage = null;
    ...
    private void jLabelFotoTareaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelFotoTareaMouseClicked
        ...
        if(SwingUtilities.isLeftMouseButton(evt)){
            StudentDashboardPanel.showView("homework_"+id);
        }
