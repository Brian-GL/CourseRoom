 ...
 * @author LENOVO
 */
public class StudentBoxGroupPanel extends javax.swing.JPanel implements ColorInterface{

    private Color firstColor , secondColor, thirdColor,fontColor, secondFontColor, thirdFontColor;
    private StudentGroupPanel groupPanel;
    private int id;
    /**
     * Creates new form BoxGroupPanel
     */
    public StudentBoxGroupPanel(int _id) {
        initComponents();
        try {
            ...
            this.id = _id;
            groupPanel = new StudentGroupPanel(getImage,jLabelNombreGrupo.getText(),firstColor,secondColor,thirdColor,fontColor,secondFontColor,thirdFontColor);
            StudentDashboardPanel.addView(groupPanel,"group_"+_id);
            getImage.flush();
            getImage = null;
            groupImage.flush();
            groupImage = null;
    ...
    private void jLabelFotoGrupoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelFotoGrupoMouseClicked
        ...
        if(SwingUtilities.isLeftMouseButton(evt)){
            StudentDashboardPanel.showView("group_"+id);
        }
