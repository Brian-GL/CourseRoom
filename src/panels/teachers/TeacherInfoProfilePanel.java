 ...
 * @author LENOVO
 */
public class TeacherInfoProfilePanel extends javax.swing.JPanel {
    ...
    public TeacherInfoProfilePanel() {
        initComponents();
    ...
    public void initMyComponents(){
        ...
        ImageIcon imageIcon = new ImageIcon(TeacherDashboardPanel.getUserImage());
    ...
    private void jButtonEditarPerfilMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonEditarPerfilMouseClicked
        ...
        if(SwingUtilities.isLeftMouseButton(evt)){
            TeacherDashboardPanel.showView("editProfilePanel");
        }
    ...
    public JLabel getProfilePhotoLabel(){
        return TeacherInfoProfilePanel.jLabelProfilePhoto;
    }
