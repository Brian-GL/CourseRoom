...
public class Teacher_Dashboard_Panel extends javax.swing.JPanel implements ColorInterface, DisposeInterface{
    ...
    private Teacher_Chats_Panel chatsPanel;
    private General_About_Panel aboutPanel;
    private static Teacher_Info_Profile_Panel infoProfilePanel;
    private Teacher_Edit_Profile_Panel editProfilePanel;
    private General_Music_Panel musicPanel;
    private Teacher_Notices_Panel noticesPanel;
    private Teacher_Dates_Panel datesPanel;
    private Teacher_Homeworks_Panel homeworksPanel;
    private Teacher_Dashboard_Configuration_Panel configurationPanel;
    ...
    public Teacher_Dashboard_Panel() {
        initComponents();
        try {
            ...
            configurationPanel = new Teacher_Dashboard_Configuration_Panel();
            ...
            Logger.getLogger(Teacher_Dashboard_Panel.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButtonTareasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonTareasMouseClicked
        // TODO add your handling code here:
        if(SwingUtilities.isLeftMouseButton(evt)){
            Teacher_Dashboard_Panel.showView("homeworksPanel");
        }
    ...
    private void jButtonFechasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonFechasMouseClicked
        // TODO add your handling code here:
        if(SwingUtilities.isLeftMouseButton(evt)){
            Teacher_Dashboard_Panel.showView("datesPanel");
        }
    ...
    private void jButtonAvisosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonAvisosMouseClicked
        // TODO add your handling code here:
        if(SwingUtilities.isLeftMouseButton(evt)){
            Teacher_Dashboard_Panel.showView("noticesPanel");
        }
    ...
    private void jButtonChatsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonChatsMouseClicked
        // TODO add your handling code here:
        if(SwingUtilities.isLeftMouseButton(evt)){
            Teacher_Dashboard_Panel.showView("chatsPanel");
        }
    ...
    private void jButtonMusicaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonMusicaMouseClicked
        // TODO add your handling code here:
        if(SwingUtilities.isLeftMouseButton(evt)){
            Teacher_Dashboard_Panel.showView("musicPanel");
        }
    ...
    private void jButtonAcercaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonAcercaMouseClicked
        // TODO add your handling code here:
        if(SwingUtilities.isLeftMouseButton(evt)){
            Teacher_Dashboard_Panel.showView("aboutPanel");
        }
    ...
    private void jButtonAjustesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonAjustesMouseClicked
        // TODO add your handling code here:
        if(SwingUtilities.isLeftMouseButton(evt)){
            Teacher_Dashboard_Panel.showView("configurationPanel");
        }
