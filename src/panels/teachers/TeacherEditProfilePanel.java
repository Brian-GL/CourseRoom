 ...
 * @author LENOVO
 */
public class TeacherEditProfilePanel extends javax.swing.JPanel {
    /**
            ...
            int result = fileChooser.showOpenDialog(this);
             ...
             if (result == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    Image scaled = TeacherDashboardPanel.getUserImage().getScaledInstance(large, large, Image.SCALE_SMOOTH);
                    ImageIcon autenticacionIcon = new ImageIcon(scaled);
                    
                    jLabelImagenPerfilAutenticacion.setIcon(autenticacionIcon);
                    
                    TeacherDashboardPanel.setUserImage(openImage);
                    ...
                    Logger.getLogger(TeacherEditProfilePanel.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private void jButtonRegresarPerfilMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonRegresarPerfilMouseClicked
        // TODO add your handling code here:
        if(SwingUtilities.isLeftMouseButton(evt)){
            TeacherDashboardPanel.showView("infoProfilePanel");
        }
