...
public class Teacher_Box_Chat_Panel extends javax.swing.JPanel implements ColorInterface, DisposeInterface{
    ...
    public Teacher_Box_Chat_Panel(int _id) {
        initComponents();
        try {
            ...
            this.id = _id;
            chatPanel = new Teacher_Chat_Panel(jLabelNombreChat.getText(),firstColor, fontColor,secondColor);
            Teacher_Dashboard_Panel.addView(chatPanel,"chat_"+id);
            ...
            Logger.getLogger(Teacher_Box_Chat_Panel.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jLabelFotoChatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelFotoChatMouseClicked
        ...
        if(SwingUtilities.isLeftMouseButton(evt)){
            Teacher_Dashboard_Panel.showView("chat_"+id);
        }
