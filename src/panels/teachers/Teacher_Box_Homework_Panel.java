...
public class Teacher_Box_Homework_Panel extends javax.swing.JPanel implements ColorInterface{
    ...
    private int id;
    //private Teacher_Homework_Panel homeworkPanel;
    
    /**
     * Creates new form BoxHomeworkPanel
     */
    public Teacher_Box_Homework_Panel(int _id) {
        initComponents();
         try {
            ...
            Logger.getLogger(Teacher_Box_Homework_Panel.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jLabelFotoTareaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelFotoTareaMouseClicked
        ...
        if(SwingUtilities.isLeftMouseButton(evt)){
            Teacher_Dashboard_Panel.showView("homework_"+id);
        }
