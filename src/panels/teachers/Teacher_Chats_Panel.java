 ...
 * @author LENOVO
 */
public class Teacher_Chats_Panel extends javax.swing.JPanel implements DisposeInterface{
    
    
    @SuppressWarnings("OverridableMethodCallInConstructor")
    public Teacher_Chats_Panel(){
       ...
       Faker faker = new Faker();
        for(int i = 0; i < faker.number().numberBetween(1, 10);i++){
            Teacher_Box_Chat_Panel boxChatPanel = new Teacher_Box_Chat_Panel(i);
