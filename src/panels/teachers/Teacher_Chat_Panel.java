 ...
 * @author LENOVO
 */
public class Teacher_Chat_Panel extends javax.swing.JPanel implements DisposeInterface{

    private Color firstColor, secondColor, fontColor;
    
    public Teacher_Chat_Panel(String name, Color _firstColor, Color _fontColor, Color _secondColor) {
        initComponents();
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            if(file != null){
                ...
                try {
                    ...
                    Logger.getLogger(Teacher_Chat_Panel.class.getName()).log(Level.SEVERE, null, ex);
                }
