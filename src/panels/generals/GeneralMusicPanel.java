 ...
 * @author brian-gl
 */
public final class GeneralMusicPanel extends javax.swing.JPanel implements ColorInterface, DisposeInterface{
                   ...
                   File[] files = folder.listFiles(filter);
                    if(files.length > 0){
                        ...
                        for (File file : files){
                            ...
                            GeneralPlaylistEntryPanel playlistEntryPanel = new GeneralPlaylistEntryPanel(filename,idx);
    ...
    private void loadMetadata(){
        try {
            ...
            if(readFile.exists()){      
                ...
                GeneralPlaylistEntryPanel playlistEntryPanel = (GeneralPlaylistEntryPanel)jPanelPlaylist.getComponent(index);
    ...
    public void setColors(Image image) {
        try {
            ...
            if (pg.grabPixels()) {
                ...
                for (Component component : components){
                    GeneralPlaylistEntryPanel playlistEntryPanel = (GeneralPlaylistEntryPanel)component;
