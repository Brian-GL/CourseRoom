...
public class Inicio_Sesion_General_Panel extends javax.swing.JPanel implements Componentes_Interface{
    ...
    private void initComponents() {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(mostrar_Contrasena_JCheckBox, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(recuperar_Credenciales_JLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 354, Short.MAX_VALUE)
                            .addComponent(crear_Cuenta_JLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addComponent(imagen_JLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 644, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(16, 16, 16)
                .addComponent(logo_JLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE)
                .addGap(5, 5, 5)
                ...
                .addGap(7, 7, 7)
                .addComponent(iniciar_Sesion_JButton, javax.swing.GroupLayout.DEFAULT_SIZE, 69, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                ...
                .addComponent(marca_JLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
                .addGap(17, 17, 17))
    ...
    private void iniciar_Sesion_JButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iniciar_Sesion_JButtonMouseEntered
        // TODO add your handling code here:
        iniciar_Sesion_JButton.setBackground(MainFrame.getFirstColor());
        iniciar_Sesion_JButton.setForeground(MainFrame.getSecondColor());
    ...
    private void iniciar_Sesion_JButtonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iniciar_Sesion_JButtonMouseExited
        ...
        iniciar_Sesion_JButton.setBackground(MainFrame.getSecondColor());
        iniciar_Sesion_JButton.setForeground(MainFrame.getFirstColor());
    ...
    public void Iniciar_Componentes() {
        ...
        try {
            ...
            String tooltip = MainFrame.Concatenar("Imagen De ",url_Imagen.getHost());
    ...
    public void Colorear_Componentes() {
        usuario_JLabel.setForeground(MainFrame.getSecondColor());
        contrasena_JLabel.setForeground(MainFrame.getSecondColor());
        
        usuario_JTextField.setBackground(MainFrame.getSecondColor());
        usuario_JTextField.setForeground(MainFrame.getFirstColor());
        usuario_JTextField.setCaretColor(MainFrame.getFirstColor());
        
        contrasena_JPasswordField.setBackground(MainFrame.getSecondColor());
        contrasena_JPasswordField.setForeground(MainFrame.getFirstColor());
        contrasena_JPasswordField.setCaretColor(MainFrame.getFirstColor());
        
        recuperar_Credenciales_JLabel.setBackground(MainFrame.getSecondColor());
        crear_Cuenta_JLabel.setBackground(MainFrame.getSecondColor());
        
        recuperar_Credenciales_JLabel.setForeground(MainFrame.getFirstColor());
        crear_Cuenta_JLabel.setForeground(MainFrame.getFirstColor());
        
        marca_JLabel.setForeground(MainFrame.getSecondColor());
        
        iniciar_Sesion_JButton.setBackground(MainFrame.getSecondColor());
        iniciar_Sesion_JButton.setForeground(MainFrame.getFirstColor());
        
        mostrar_Contrasena_JCheckBox.setForeground(MainFrame.getSecondColor());
    }
}
