 ...
 * @author LENOVO
 */
public class General_Member_Panel extends javax.swing.JPanel implements ColorInterface{
    ...
    public General_Member_Panel() {
        ...
        try {
            ...
            Logger.getLogger(General_Member_Panel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
