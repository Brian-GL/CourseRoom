 ...
 * @author LENOVO
 */
public class General_Text_Message_Panel extends javax.swing.JPanel implements DisposeInterface{

    public General_Text_Message_Panel(String sender, String message, String date) {
        initComponents();
