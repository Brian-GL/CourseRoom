...
public class Entrada_Lista_Reproduccion_General_Panel extends javax.swing.JPanel {
    ...
    public boolean No_Esta_Seteado(){
        return artista_JLabel.getText().isEmpty();
    }
    
    public void Establecer_Artista(String artista){
        artista_JLabel.setText(artista);
    }
    
    public void Establecer_Album(String album){
        album_JLabel.setText(album);
    }
    
    public void Establecer_Imagen_Arte(Image imagen){
        ImageIcon icono = new ImageIcon(imagen);
        imagen_Arte_JLabel.setIcon(icono);
        imagen.flush();
    }
    
    public void Establecer_Colores_Fuente(Color color){
