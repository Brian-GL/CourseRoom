 ...
 * @author LENOVO
 */
public class General_Crear_Cuenta_Panel extends javax.swing.JPanel{

    /**
     * Creates new form CrearCuentaPanel
     */
    @SuppressWarnings("OverridableMethodCallInConstructor")
    public General_Crear_Cuenta_Panel() {
        initComponents();
        ...
        if(SwingUtilities.isLeftMouseButton(evt)){
            ...
            if (result == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    Logger.getLogger(General_Crear_Cuenta_Panel.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
