 ...
 * @author brian
 */
public class GeneralDatesPanel extends javax.swing.JPanel implements DisposeInterface{
    ...
    private void setMonth(int index_month_days, int previous_index_month_days){
        ...
        for(int i = until; i > 0;i--){
            GeneralBoxDatePanel calendarDayPanel = new GeneralBoxDatePanel(previous_index_month_days-i);
        ...
        for(int i = 1; i < index_month_days;i++){
            GeneralBoxDatePanel calendarDayPanel = new GeneralBoxDatePanel(i);
