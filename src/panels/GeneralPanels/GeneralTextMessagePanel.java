 ...
 * @author LENOVO
 */
public class GeneralTextMessagePanel extends javax.swing.JPanel implements DisposeInterface{

    public GeneralTextMessagePanel(String sender, String message, String date) {
        initComponents();
