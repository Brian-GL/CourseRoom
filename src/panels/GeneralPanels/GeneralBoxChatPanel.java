 ...
 * @author LENOVO
 */
public class GeneralBoxChatPanel extends javax.swing.JPanel implements ColorInterface, DisposeInterface{

    private Color firstColor, fontColor, secondColor;
    private GeneralChatPanel chatPanel;
    private int id;
    
    @SuppressWarnings("OverridableMethodCallInConstructor")
    public GeneralBoxChatPanel(int _id) {
        initComponents();
        try {
            ...
            this.id = _id;
            chatPanel = new GeneralChatPanel(jLabelNombreChat.getText(),firstColor, fontColor,secondColor);
            StudentDashboardPanel.addView(chatPanel,"chat_"+id);
            ...
            Logger.getLogger(GeneralBoxChatPanel.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jLabelFotoChatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelFotoChatMouseClicked
        ...
        if(SwingUtilities.isLeftMouseButton(evt)){
            StudentDashboardPanel.showView("chat_"+id);
        }
