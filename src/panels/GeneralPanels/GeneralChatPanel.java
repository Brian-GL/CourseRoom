 ...
 * @author LENOVO
 */
public class GeneralChatPanel extends javax.swing.JPanel implements DisposeInterface{

    private Color firstColor, secondColor, fontColor;
    
    public GeneralChatPanel(String name, Color _firstColor, Color _fontColor, Color _secondColor) {
        initComponents();
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            if(file != null){
                ...
                try {
                    ...
                    Logger.getLogger(GeneralChatPanel.class.getName()).log(Level.SEVERE, null, ex);
                }
