 ...
 * @author LENOVO
 */
public class GeneralHomeworkUploadFile extends javax.swing.JPanel {

    private Color foreground,secondForeground,backgroud, secondBackground;
    /**
     * Creates new form StudentHomeworkUploadFile
     */
    public GeneralHomeworkUploadFile(File file, Color _background, Color _foreground, Color _secondBackground, Color _secondForeground) {
        initComponents();
