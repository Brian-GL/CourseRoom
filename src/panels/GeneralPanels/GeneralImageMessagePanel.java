 ...
 * @author LENOVO
 */
public class GeneralImageMessagePanel extends javax.swing.JPanel implements DisposeInterface{

    public GeneralImageMessagePanel(String sender, String date, Image image, String filename) {
        initComponents();
