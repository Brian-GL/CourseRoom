 ...
 * @author LENOVO
 */
public class GeneralEditProfilePanel extends javax.swing.JPanel {
    /**
     * Creates new form EditProfilePanel
     */
    @SuppressWarnings("OverridableMethodCallInConstructor")
    public GeneralEditProfilePanel() {
        initComponents();
        initMyComponents();
            ...
            int result = fileChooser.showOpenDialog(this);
             ...
             if (result == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    Image scaled = StudentDashboardPanel.getUserImage().getScaledInstance(large, large, Image.SCALE_SMOOTH);
                    ...
                    Logger.getLogger(GeneralEditProfilePanel.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private void jButtonRegresarPerfilMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonRegresarPerfilMouseClicked
        // TODO add your handling code here:
        if(SwingUtilities.isLeftMouseButton(evt)){
            StudentDashboardPanel.showView("infoProfilePanel");
        }
