 ...
 * @author LENOVO
 */
public class GeneralChatsPanel extends javax.swing.JPanel implements DisposeInterface{
    
    
   
    @SuppressWarnings("OverridableMethodCallInConstructor")
    public GeneralChatsPanel(){
       ...
       Faker faker = new Faker();
        for(int i = 0; i < faker.number().numberBetween(1, 10);i++){
            GeneralBoxChatPanel boxChatPanel = new GeneralBoxChatPanel(i);
