...
public class Caja_Fecha_Estudiante_Panel extends javax.swing.JPanel implements Componentes_Interface{
    ...
    private void initComponents() {
        ...
        numero_Dia_JLabel.setFont(new java.awt.Font("Gadugi", 1, 24)); // NOI18N
        ...
        descripcion_JLabel.setFont(new java.awt.Font("Gadugi", 0, 11)); // NOI18N
    ...
    public void Iniciar_Componentes() {
        color_Fondo = MainFrame.getThirdColor();
        color_Fuente = MainFrame.getThirdFontColor();
        String concatenacion = 
        MainFrame.Concatenar(String.valueOf(MainFrame.getFaker().number().randomNumber(2, true)),
                ":",String.valueOf(MainFrame.getFaker().number().randomNumber(2, false))," P.M");
        horar_JLabel.setText(concatenacion);
        descripcion_JLabel.setText(MainFrame.ToHTMLCenterFormat(MainFrame.getFaker().lorem().paragraph()));
