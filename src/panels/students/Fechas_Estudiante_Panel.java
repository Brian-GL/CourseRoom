...
public class Fechas_Estudiante_Panel extends javax.swing.JPanel implements Limpieza_Interface,Componentes_Interface{
    ...
    private void Establecer_Mes(int dias_del_mes, int dias_del_mes_anterior){
        ...
        for(int i = hasta_Valor; i > 0;i--){
            ...
            dia_Calendario_Panel.Establecer_Colores(MainFrame.getThirdColor(), MainFrame.getThirdFontColor());
        ...
        for(int i = 1; i < dias_del_mes;i++){
            ...
            if(tiempo_actual.getDayOfMonth() == i){
                dia_Calendario_Panel.Establecer_Colores(MainFrame.getFirstColor(), MainFrame.getFontColor());
                calendario_JPanel.add(dia_Calendario_Panel);
            } else{
                 dia_Calendario_Panel.Establecer_Colores(MainFrame.getSecondColor(), MainFrame.getSecondFontColor());
                calendario_JPanel.add(dia_Calendario_Panel);
            }
            cuenta++;
        }
        ...
        while(cuenta < 42){
            dia_Calendario_Panel = new Caja_Fecha_Estudiante_Panel(i);
            dia_Calendario_Panel.Establecer_Colores(MainFrame.getThirdColor(), MainFrame.getFirstColor());
            calendario_JPanel.add(dia_Calendario_Panel);
            i++;
            cuenta++;
        }
    ...
    public void Colorear_Componentes(){
        ...
        mes_JLabel.setBackground(MainFrame.getSecondColor());
        mes_JLabel.setForeground(MainFrame.getSecondFontColor());
        
        lunes_JLabel.setForeground(MainFrame.getFontColor());
        martes_JLabel.setForeground(MainFrame.getFontColor());
        miercoles_JLabel.setForeground(MainFrame.getFontColor());
        jueves_JLabel.setForeground(MainFrame.getFontColor());
        viernes_JLabel.setForeground(MainFrame.getFontColor());
        sabado_JLabel.setForeground(MainFrame.getFontColor());
        domingo_JLabel.setForeground(MainFrame.getFontColor());
        siguiente_Mes_JLabel.setForeground(MainFrame.getFontColor());
        anterior_Mes_JLabel.setForeground(MainFrame.getFontColor());
