 ...
 * @author LENOVO
 */
public class StudentChatPanel extends javax.swing.JPanel implements DisposeInterface{

    private Color firstColor, secondColor, fontColor;
    
    public StudentChatPanel(String name, Color _firstColor, Color _fontColor, Color _secondColor) {
        initComponents();
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            if(file != null){
                ...
                try {
                    ...
                    Logger.getLogger(StudentChatPanel.class.getName()).log(Level.SEVERE, null, ex);
                }
