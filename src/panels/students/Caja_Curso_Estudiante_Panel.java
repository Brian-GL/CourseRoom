...
public class Caja_Curso_Estudiante_Panel extends javax.swing.JPanel implements Color_Interface,Limpieza_Interface,Componentes_Interface{
    ...
    private void initComponents() {
        ...
        nombre_JLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons/online-test.png"))); // NOI18N
        nombre_JLabel.setToolTipText("Nombre Del Curso");

        nombre_Profesor_JLabel.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        nombre_Profesor_JLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons/teacher.png"))); // NOI18N
    ...
    public void Iniciar_Componentes() {
        try {
            ...
            ImageIcon estrella = new ImageIcon(getClass().getResource("/resources/icons/star.png"));
            for(int i = 0; i < 4;i++){
                try {
