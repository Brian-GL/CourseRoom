...
public class StudentDashboardPanel extends javax.swing.JPanel implements ColorInterface, DisposeInterface{
    ...
    private StudentChatsPanel chatsPanel;
    private StudentAboutPanel aboutPanel;
    ...
    public StudentDashboardPanel() {
        ...
        try {
            ...
            infoProfilePanel = new StudentInfoProfilePanel();
            jPanelInformacion.add("infoProfilePanel",infoProfilePanel);
            
            editProfilePanel = new StudentEditProfilePanel();
            ...
            chatsPanel = new StudentChatsPanel();
            jPanelInformacion.add("chatsPanel",chatsPanel);
            
            
            aboutPanel = new StudentAboutPanel();
