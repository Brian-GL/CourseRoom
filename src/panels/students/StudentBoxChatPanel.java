 ...
 * @author LENOVO
 */
public class StudentBoxChatPanel extends javax.swing.JPanel implements ColorInterface, DisposeInterface{

    private Color firstColor, fontColor, secondColor;
    private StudentChatPanel chatPanel;
    private int id;
    
    @SuppressWarnings("OverridableMethodCallInConstructor")
    public StudentBoxChatPanel(int _id) {
        initComponents();
        try {
            ...
            this.id = _id;
            chatPanel = new StudentChatPanel(jLabelNombreChat.getText(),firstColor, fontColor,secondColor);
