...
public class ImageFrame extends javax.swing.JFrame {
    ...
    public ImageFrame() {
        initComponents();
        int imageHeight = jLabelImage.getHeight();
        int imageWidth = jLabelImage.getWidth();
    ...
    private void initComponents() {
        ...
        jLabelImage.setMinimumSize(new java.awt.Dimension(800, 600));
        jLabelImage.setPreferredSize(new java.awt.Dimension(800, 600));
