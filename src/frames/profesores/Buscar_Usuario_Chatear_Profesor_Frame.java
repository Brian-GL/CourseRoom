 ...
 * @author LENOVO
 */
public class Buscar_Usuario_Chatear_Profesor_Frame extends javax.swing.JFrame implements Componentes_Interface{

    private static Buscar_Usuario_Chatear_Profesor_Frame _this;
    
    /**
     * Creates new form Buscar_Usuario_Chatear_Frame
     */
    public Buscar_Usuario_Chatear_Profesor_Frame() {
        initComponents();
        Iniciar_Componentes();
    }
                ...
                public void mousePressed(MouseEvent e) {
                    if (e.getClickCount() == 2) {
                        ...
                        if (columna == 1) {
                            ...
                            ResponseModel response = CourseRoom.Solicitudes().Agregar_Chat(Tablero_Profesor_Panel.Id_Usuario()
                                ,id_Usuario_Receptor);

                            if(response.Is_Success()){
                                CourseRoom.Utilerias().Mensaje_Informativo("Agregar Chat", response.Mensaje());
                                Buscar_Usuario_Chatear_Profesor_Frame.Limpiar();
