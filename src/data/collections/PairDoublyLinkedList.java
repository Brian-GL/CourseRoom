...
public class PairDoublyLinkedList<A,B>{
    ...
    //Public constructors
    public PairDoublyLinkedList() {
        _size = 0;
    }

    @SuppressWarnings("OverridableMethodCallInConstructor")
    public PairDoublyLinkedList(PairDoublyLinkedList<A,B> list) {
        this._size = 0;
    ...
    public void join_back(PairDoublyLinkedList<A,B> list) {
        if (list != null) {
    ...
    public void join_front(PairDoublyLinkedList<A,B> list) {
        if (list != null) {
            PairNode<A,B> auxiliar = list.front();
    ...
    public void concatenate_front(PairDoublyLinkedList<A,B> list) {
        if (list != null) {
            PairNode<A,B> auxiliar = list.front();
    ...
    public void concatenate_back(PairDoublyLinkedList<A,B> list) {
        if (list != null) {
            PairNode<A,B> auxiliar = list.front();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PairDoublyLinkedList<?,?>)) {
            return false;
        }

        PairDoublyLinkedList<A,B> other = (PairDoublyLinkedList<A,B>) obj;
