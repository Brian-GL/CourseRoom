...
public class Graph<T>{
    ...
    public class Vertex{
        ...
        private DoublyLinkedList<Edge> _edge_list;
        ...
        public Vertex(T element) { 
            this._edge_list = new DoublyLinkedList<>();
        ...
        public DoublyLinkedList<Edge> edge_list(){return this._edge_list;}
    ...
    /**The all edges list*/
    private DoublyLinkedList<Edge> _allEdges;
    ...
    private void _init() {
            ...
            this._size = 0;
            this._allWeight = 0.0;
            this._allEdges = new DoublyLinkedList<>();
    }
    ...
    @SuppressWarnings("OverridableMethodCallInConstructor")
    public Graph(DoublyLinkedList<T> list) {
    ...
    @SuppressWarnings("OverridableMethodCallInConstructor")
    public Graph(Collection<T> structure) {
    ...
    public DoublyLinkedList<Edge> edge_list(){return _allEdges;}
