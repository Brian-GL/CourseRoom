 ...
 * @author Erick
 */
public class EntregasTareasPorCalificarModel {
    ...
    public EntregasTareasPorCalificarModel(int id_Tarea, String nombre, int id_Curso, String nombre_Curso,int id_Usuario, String nombre_Completo, String fecha_Subida, String fecha_Entrega) {
    ...
    public EntregasTareasPorCalificarModel(){
        this.id_Tarea = this.id_Curso = this.id_Usuario = 0;
