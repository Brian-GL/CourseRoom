...
public class Cursos_Nuevos_Estudiante_Panel extends javax.swing.JPanel implements Limpieza_Interface, Componentes_Interface{
    ...
    public void Iniciar_Componentes() {
        ...
        for (int i = 0; i < CourseRoom.Faker().number().numberBetween(5, 20); i++) {
            ...
            try {
                System.out.println("Curso Nuevo ID: " + i + " -> Getting Image From https://picsum.photos/450/450");
                ...
                System.out.println("Curso Nuevo Profesor: " + i + " -> Getting Image From https://i.pravatar.cc/450");
