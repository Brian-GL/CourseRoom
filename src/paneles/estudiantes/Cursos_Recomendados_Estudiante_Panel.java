...
public class Cursos_Recomendados_Estudiante_Panel extends javax.swing.JPanel implements Limpieza_Interface, Componentes_Interface{
    ...
    private Titulo_Cursos_Recomendados_Estudiante_Panel titulo_Cursos_Estudiante_Panel;
    ...
    public void Iniciar_Componentes() {
        ...
        titulo_Cursos_Estudiante_Panel = new Titulo_Cursos_Recomendados_Estudiante_Panel();
        ...
        for(int i = 0; i < CourseRoom.Faker().number().numberBetween(1, 10);i++){
            concatenacion = CourseRoom.Concatenar("Curso_Recomendado_",i);
