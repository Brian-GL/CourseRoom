...
public class Preguntas_Profesor_Panel extends javax.swing.JPanel implements Limpieza_Interface, Componentes_Interface {
    ...
    private void initComponents() {
        ...
        buscar_Preguntas_JButton.setToolTipText("<html> <h3>Buscar<br>Pregunta(s)</h3> </html>");
        ...
        preguntar_JButton.setToolTipText("<html> <h3>Nueva<br>Preguntar</h3> </html>");
    ...
    public void Agregar_Pregunta(PreguntasModel preguntasModel) {
        ...
        if(Tablero_Profesor_Panel.Obtener_Imagen_Usuario() != null){
            imagen_Usuario = Tablero_Profesor_Panel.Obtener_Imagen_Usuario().getScaledInstance(95, 95, Image.SCALE_SMOOTH);
            ImageIcon icono_Usuario = new ImageIcon(imagen_Usuario);
