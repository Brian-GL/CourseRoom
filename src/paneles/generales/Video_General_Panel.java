 ...
 * @author LENOVO
 */
public class Video_General_Panel extends javax.swing.JPanel implements Reproductor_Interface, Limpieza_Interface, Componentes_Interface{
    ...
    public void Establecer_Eventos_Reproductor(){
        ...
        componente_Embebido_Video.mediaPlayer().events().addMediaPlayerEventListener(new MediaPlayerEventListener() {
            ...
            public void mediaPlayerReady(MediaPlayer mp) {
                longitud = componente_Embebido_Video.mediaPlayer().status().length();
