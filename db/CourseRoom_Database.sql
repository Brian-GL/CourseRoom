...
INSERT INTO `tb_tematicasusuarios` (`IdTematica`, `IdUsuario`) VALUES (30,1),(77,1),(95,1),(275,1),(278,1);
...
BEGIN
    ...
    WHERE IdTarea = _IdTarea AND Activo = 1 LIMIT 1);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `fn_NombrrCurso` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`courseroom_server`@`localhost` FUNCTION `fn_NombrrCurso`(_IdCurso INT) RETURNS varchar(250) CHARSET utf8mb4
    DETERMINISTIC
BEGIN
...
BEGIN
    ...
    IF courseroom.fn_CampoValido(_Aviso) = 1 AND courseroom.fn_CampoValido(_TipoAviso) THEN
		...
		IF EXISTS(SELECT IdCurso FROM tb_cursos WHERE IdCurso = _IdCurso AND Activo = 1) THEN
			...
			CREATE TEMPORARY TABLE tabla_Cursos (SELECT IdUsuario FROM tb_cursosusuarios WHERE IdCurso = _IdCurso AND IdUsuario <> _IdUsuario);
...
-- Dump completed on 2022-04-14 21:57:56
