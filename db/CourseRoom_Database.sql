...
INSERT INTO `tb_tematicas` VALUES (1,'ABOGACÍA','ESTUDIOS JURIDICOS'),(2,'ACTUARIA','ECONOMIA Y SOCIEDAD'),(3,'ADMINISTRACIÓN','GESTION EMPRESARIAL'),(4,'ADMINISTRACIÓN AGRARIA','AGRONOMIA'),(5,'ADMINISTRACIÓN AGROPECUARIA','AGRONOMIA'),(6,'ADMINISTRACIÓN DE EMPRESAS','GESTION EMPRESARIAL'),(7,'ADMINISTRACIÓN DE NEGOCIOS','GESTION EMPRESARIAL'),(8,'ADMINISTRACIÓN DE ORGANIZACIONES DE SALUD','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(9,'ADMINISTRACIÓN DE POLÍTICAS PÚBLICAS','ECONOMIA Y SOCIEDAD'),(10,'ADMINISTRACIÓN DE POLÍTICAS PÚBLICAS LOCALES','ECONOMIA Y SOCIEDAD'),(11,'ADMINISTRACIÓN DE SISTEMAS','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(12,'ADMINISTRACIÓN EDUCATIVA','CIENCIAS DE LA EDUCACION'),(13,'ADMINISTRACIÓN FINANCIERA','GESTION EMPRESARIAL'),(14,'ADMINISTRACIÓN GUBERNAMENTAL','GESTION EMPRESARIAL'),(15,'ADMINISTRACIÓN PÚBLICA','GESTION EMPRESARIAL'),(16,'ADMINISTRACIÓN URBANA','GESTION EMPRESARIAL'),(17,'ADUANAS','GESTION EMPRESARIAL'),(18,'AGROBIOTECNOLOGÍA','AGRONOMIA'),(19,'AGRONEGOCIOS','AGRONOMIA'),(20,'ALIMENTOS Y BEBIDAS','DISCIPLINAS CLINICAS'),(21,'ANÁLISIS DE SISTEMAS','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(22,'ANÁLISIS DE SISTEMAS INFORMÁTICOS','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(23,'ANESTESIOLOGÍA PEDIÁTRICA','DISCIPLINAS CLINICAS'),(24,'ANTROPOLOGÍA','ESTUDIOS HISTORICOS Y HUMANOS'),(25,'ANTROPOLOGÍA FÍSICA','ESTUDIOS HISTORICOS Y HUMANOS'),(26,'ARCHIVONOMÍA','ESTUDIOS DE LA CULTURA'),(27,'ARQUEOLOGÍA','ESTUDIOS HISTORICOS Y HUMANOS'),(28,'ARQUITECTURA','IMAGEN Y SONIDO'),(29,'ARTE','ARTES VISUALES'),(30,'ARTES AUDIOVISUALES','ARTES VISUALES'),(31,'ARTES ESCÉNICAS PARA LA EXPRESIÓN DANCÍSTICA','ARTES ESCENICAS'),(32,'ARTES ESCÉNICAS PARA LA EXPRESIÓN TEATRAL','ARTES ESCENICAS'),(33,'ARTES VISUALES PARA LA EXPRESIÓN FOTOGRÁFICA','ARTES VISUALES'),(34,'ARTES VISUALES PARA LA EXPRESIÓN PLÁSTICA','ARTES VISUALES'),(35,'ASISTENTE DIRECTIVO','GESTION EMPRESARIAL'),(36,'ASISTENTE EJECUTIVO','GESTION EMPRESARIAL'),(37,'AUDIOLOGÍA','DISCIPLINAS CLINICAS'),(38,'BIBLIOTECOLOGÍA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(39,'BIOINGENIERÍA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(40,'BIOLOGÍA','CIENCIAS BASICAS'),(41,'BIOLOGÍA EXPERIMENTAL','BIOLOGIA'),(42,'BIOLOGÍA MARINA','BIOLOGIA'),(43,'BIOMÉDICA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(44,'BIOMEDICINA BÁSICA','CIENCIAS BASICAS'),(45,'BIOMEDICINA EXPERIMENTAL','CIENCIAS BASICAS'),(46,'BIOQUÍMICA DIAGNOSTICA','CIENCIAS BASICAS'),(47,'BIOTECNOLOGÍA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(48,'CARDIOLOGÍA PEDIÁTRICA','DISCIPLINAS CLINICAS'),(49,'CIENCIA DE DATOS','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(50,'CIENCIA DE EDIFICACIÓN','INGENIERIAS'),(51,'CIENCIA DE LOS ALIMENTOS','DISCIPLINAS CLINICAS'),(52,'CIENCIA Y TECNOLOGÍA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(53,'CIENCIAS ADMINISTRATIVAS','GESTION EMPRESARIAL'),(54,'CIENCIAS AGRARIAS','AGRONOMIA'),(55,'CIENCIAS AGROPECUARIAS','AGRONOMIA'),(56,'CIENCIAS APLICADAS','CIENCIAS BASICAS'),(57,'CIENCIAS BIOLÓGICAS','BIOLOGIA'),(58,'CIENCIAS BIOMÉDICAS','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(59,'CIENCIAS CONTABLES','CONTADURIA'),(60,'CIENCIAS DE AUDITORIA','CONTADURIA'),(61,'CIENCIAS DE LA COMUNICACIÓN','INGENIERIAS'),(62,'CIENCIAS DE LA EDUCACIÓN','CIENCIAS DE LA EDUCACION'),(63,'CIENCIAS DE LA EMPRESA','GESTION EMPRESARIAL'),(64,'CIENCIAS DE LA INFORMÁTICA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(65,'CIENCIAS DE LA PRODUCCIÓN','GESTION EMPRESARIAL'),(66,'CIENCIAS DE LA SALUD','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(67,'CIENCIAS DEL ARTE','IMAGEN Y SONIDO'),(68,'CIENCIAS DEL DEPORTE','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(69,'CIENCIAS DIPLOMÁTICAS','ESTUDIOS POLITICOS Y SOCIALES'),(70,'CIENCIAS ECONÓMICAS','ECONOMIA Y SOCIEDAD'),(71,'CIENCIAS EMPRESARIALES','GESTION EMPRESARIAL'),(72,'CIENCIAS FARMACÉUTICAS','CIENCIAS BASICAS'),(73,'CIENCIAS FORESTALES','INGENIERIAS'),(74,'CIENCIAS HUMANAS','ESTUDIOS HISTORICOS Y HUMANOS'),(75,'CIENCIAS INFORMÁTICAS','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(76,'CIENCIAS JURÍDICAS','ESTUDIOS JURIDICOS'),(77,'CIENCIAS MÉDICAS','DISCIPLINAS CLINICAS'),(78,'CIENCIAS POLÍTICAS','ESTUDIOS POLITICOS Y SOCIALES'),(79,'CIENCIAS QUÍMICAS','CIENCIAS BASICAS'),(80,'CIENCIAS QUIMICOBIOLOGICAS','CIENCIAS BASICAS'),(81,'CIENCIAS SOCIALES','ESTUDIOS POLITICOS Y SOCIALES'),(82,'CIENCIAS TECNOLOGÍCAS','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(83,'CIENCIAS VETERINARIAS','CIENCIAS VETERINARIAS'),(84,'CIENCIAS Y ARTE','IMAGEN Y SONIDO'),(85,'CINEMATOGRAFÍA','ARTES VISUALES'),(86,'CIRUGÍA PLÁSTICA ESTÉTICA','DISCIPLINAS CLINICAS'),(87,'CIRUGÍA PLÁSTICA RECONSTRUCTIVA','DISCIPLINAS CLINICAS'),(88,'CIRUJANO DENTISTA','DISCIPLINAS CLINICAS'),(89,'COMERCIALIZACIÓN','GESTION EMPRESARIAL'),(90,'COMERCIO EXTERIOR','GESTION EMPRESARIAL'),(91,'COMERCIO INTERNACIONAL','GESTION EMPRESARIAL'),(92,'COMPOSICIÓN','IMAGEN Y SONIDO'),(93,'COMPUTACIÓN','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(94,'COMUNICACIÓN AUDIOVISUAL','ESTUDIOS DE LA CULTURA'),(95,'COMUNICACIÓN HUMANA','ESTUDIOS DE LA CULTURA'),(96,'COMUNICACIÓN PÚBLICA','ESTUDIOS DE LA CULTURA'),(97,'COMUNICACIÓN SOCIAL','ESTUDIOS DE LA CULTURA'),(98,'COMUNICACIÓN VISUAL','ESTUDIOS DE LA CULTURA'),(99,'CONSTRUCCIÓN','INGENIERIAS'),(100,'CONTABILIDAD','CONTADURIA'),(101,'CONTABILIDAD FINANCIERA','CONTADURIA'),(102,'CONTABILIDAD FISCAL','CONTADURIA'),(103,'CONTABILIDAD PÚBLICA','CONTADURIA'),(104,'CONTADOR PRIVADO','CONTADURIA'),(105,'CONTADOR PÚBLICO','CONTADURIA'),(106,'CONTADOR PÚBLICO NACIONAL','CONTADURIA'),(107,'CONTADURÍA','CONTADURIA'),(108,'CONTADURÍA PRIVADA','CONTADURIA'),(109,'CONTADURÍA PÚBLICA','CONTADURIA'),(110,'CRIMINALÍSTICA','ESTUDIOS POLITICOS Y SOCIALES'),(111,'CRIMINOLOGÍA','ESTUDIOS POLITICOS Y SOCIALES'),(112,'CULTURA FÍSICA Y DEPORTES','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(113,'DERECHO','ESTUDIOS JURIDICOS'),(114,'DERECHO ADMINISTRATIVO','ECONOMIA Y SOCIEDAD'),(115,'DESARROLLO DEL PRODUCTO','INGENIERIAS'),(116,'DESARROLLO EDUCATIVO','CIENCIAS DE LA EDUCACION'),(117,'DESARROLLO HUMANO','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(118,'DESARROLLO RURAL','AGRONOMIA'),(119,'DIDÁCTICA DEL FRANCÉS COMO LENGUA EXTRANJERA','ESTUDIOS HISTORICOS Y HUMANOS'),(120,'DIETÉTICA','DISCIPLINAS CLINICAS'),(121,'DIRECCIÓN DE PROYECTOS','GESTION EMPRESARIAL'),(122,'DISEÑO','IMAGEN Y SONIDO'),(123,'DISEÑO ARQUITECTÓNICO','IMAGEN Y SONIDO'),(124,'DISEÑO DE ARTESANÍAS','IMAGEN Y SONIDO'),(125,'DISEÑO DE INTERIORES Y AMBIENTACIÓN','IMAGEN Y SONIDO'),(126,'DISEÑO DE MODAS','IMAGEN Y SONIDO'),(127,'DISEÑO GRÁFICO','IMAGEN Y SONIDO'),(128,'DISEÑO INDUSTRIAL','IMAGEN Y SONIDO'),(129,'DISEÑO PARA LA COMUNICACIÓN GRÁFICA','IMAGEN Y SONIDO'),(130,'DOCENCIA DEL INGLÉS COMO LENGUA EXTRANJERA','ESTUDIOS HISTORICOS Y HUMANOS'),(131,'ECONOMÍA','ECONOMIA Y SOCIEDAD'),(132,'EDUCACIÓN (ABIERTA Y A DISTANCIA)','CIENCIAS DE LA EDUCACION'),(133,'EDUCACIÓN ESPECIAL','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(134,'EDUCACIÓN ESPECIAL DE AUDICIÓN','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(135,'EDUCACIÓN ESPECIAL DE LENGUAJE','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(136,'EDUCACIÓN PARA LA SALUD','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(137,'EDUCACIÓN PREESCOLAR','CIENCIAS DE LA EDUCACION'),(138,'EJECUTIVO BILINGÜE','GESTION EMPRESARIAL'),(139,'ELECTRICIDAD','INGENIERIAS'),(140,'ELECTRICISTA','INGENIERIAS'),(141,'ELECTRÓNICA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(142,'ENFERMERA QUIRÚRGICA','DISCIPLINAS CLINICAS'),(143,'ENFERMERÍA','DISCIPLINAS CLINICAS'),(144,'ENFERMERÍA DEL NEONATO','DISCIPLINAS CLINICAS'),(145,'ENFERMERÍA GENERAL','DISCIPLINAS CLINICAS'),(146,'ENFERMERÍA INFANTIL','DISCIPLINAS CLINICAS'),(147,'ENFERMERÍA PEDIÁTRICA','DISCIPLINAS CLINICAS'),(148,'ENFERMERÍA PERINATAL','DISCIPLINAS CLINICAS'),(149,'ESPECIALISTA EN ORTODONCIA','DISCIPLINAS CLINICAS'),(150,'ESTADÍSTICA','CIENCIAS BASICAS'),(151,'ESTUDIOS ÁRABES','ESTUDIOS DE ESTADO Y SOCIEDAD'),(152,'ESTUDIOS ASIA ORIENTAL','ESTUDIOS DE ESTADO Y SOCIEDAD'),(153,'ESTUDIOS DE LA INFORMACIÓN','ESTUDIOS DE ESTADO Y SOCIEDAD'),(154,'ESTUDIOS FRANCESES','ESTUDIOS DE ESTADO Y SOCIEDAD'),(155,'ESTUDIOS INGLESES','ESTUDIOS DE ESTADO Y SOCIEDAD'),(156,'ESTUDIOS ISLÁMICOS','ESTUDIOS DE ESTADO Y SOCIEDAD'),(157,'ESTUDIOS LIBERALES','ESTUDIOS DE ESTADO Y SOCIEDAD'),(158,'ESTUDIOS POLÍTICOS Y GOBIERNO','ESTUDIOS POLITICOS Y SOCIALES'),(159,'FARMACIA','CIENCIAS BASICAS'),(160,'FILOLOGÍA CLÁSICA','ESTUDIOS HISTORICOS Y HUMANOS'),(161,'FILOLOGÍA HISPÁNICA','ESTUDIOS HISTORICOS Y HUMANOS'),(162,'FILOSOFÍA','ESTUDIOS HISTORICOS Y HUMANOS'),(163,'FISIATRÍA','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(164,'FÍSICA','CIENCIAS BASICAS'),(165,'FISIOTERAPIA','DISCIPLINAS BASICAS'),(166,'FONIATRÍA','DISCIPLINAS CLINICAS'),(167,'FOTOGRÁFIA','ARTES VISUALES'),(168,'GASTRONOMÍA','CIENCIAS BASICAS'),(169,'GENÉTICA PERINATAL','DISCIPLINAS BASICAS'),(170,'GEOGRAFÍA','ESTUDIOS HISTORICOS Y HUMANOS'),(171,'GERONTOLOGÍA','DISCIPLINAS BASICAS'),(172,'GESTIÓN DE HOTELERÍA','GESTION EMPRESARIAL'),(173,'GESTIÓN DE TURISMO','GESTION EMPRESARIAL'),(174,'GESTIÓN DEL TERRITORIO','ESTUDIOS HISTORICOS Y HUMANOS'),(175,'GESTIÓN DIRECTIVA EN SALUD','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(176,'GESTIÓN Y ECONOMÍA AMBIENTAL','ECONOMIA Y SOCIEDAD'),(177,'HEMATOLOGÍA PEDIÁTRICA','DISCIPLINAS CLINICAS'),(178,'HISTORIA','ESTUDIOS HISTORICOS Y HUMANOS'),(179,'HISTORIA DEL ARTE','ESTUDIOS HISTORICOS Y HUMANOS'),(180,'HOTELERÍA','GESTION EMPRESARIAL'),(181,'HUMANIDADES','ESTUDIOS HISTORICOS Y HUMANOS'),(182,'INDUSTRIA','GESTION EMPRESARIAL'),(183,'INFORMÁTICA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(184,'INFORMÁTICA ADMINISTRATIVA','GESTION EMPRESARIAL'),(185,'INFORMÁTICA EMPRESARIAL','GESTION EMPRESARIAL'),(186,'INFORMÁTICA FINANCIERA','GESTION EMPRESARIAL'),(187,'INGENIERÍA AEROESPACIAL','INGENIERIAS'),(188,'INGENIERÍA AGRÍCOLA','AGRONOMIA'),(189,'INGENIERÍA AGROINDUSTRIAL','AGRONOMIA'),(190,'INGENIERÍA AGRONÓMICA','AGRONOMIA'),(191,'INGENIERÍA AGROPECUARIA','AGRONOMIA'),(192,'INGENIERÍA AMBIENTAL','INGENIERIAS'),(193,'INGENIERÍA BIOMÉDICA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(194,'INGENIERÍA BIOQUÍMICA','CIENCIAS BASICAS'),(195,'INGENIERÍA CIVIL','INGENIERIAS'),(196,'INGENIERÍA COMERCIAL','GESTION EMPRESARIAL'),(197,'INGENIERÍA DE ALIMENTOS','INGENIERIAS'),(198,'INGENIERÍA DE LA ENERGÍA','INGENIERIAS'),(199,'INGENIERÍA DE LA SALUD','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(200,'INGENIERÍA DE LAS TECNOLOGÍAS DE TELECOMUNICACIÓN','INGENIERIAS'),(201,'INGENIERÍA DE MATERIALES','INGENIERIAS'),(202,'INGENIERÍA DE PROCESOS Y COMERCIO INTERNACIONAL','GESTION EMPRESARIAL'),(203,'INGENIERÍA DEL SOFTWARE','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(204,'INGENIERÍA ELÉCTRICA','INGENIERIAS'),(205,'INGENIERÍA ELECTROMECÁNICA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(206,'INGENIERÍA ELECTRÓNICA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(207,'INGENIERÍA ELECTRÓNICA INDUSTRIAL','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(208,'INGENIERÍA EMPRESARIAL','INGENIERIAS'),(209,'INGENIERÍA EN ADMINISTRACIÓN INDUSTRIAL','INGENIERIAS'),(210,'INGENIERÍA EN AGROINDUSTRIA','AGRONOMIA'),(211,'INGENIERÍA EN ALIMENTOS Y BIOTECNOLOGÍA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(212,'INGENIERÍA EN BIOTECNOLOGÍA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(213,'INGENIERÍA EN CIENCIAS COMPUTACIONALES','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(214,'INGENIERÍA EN COMPUTACIÓN','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(215,'INGENIERÍA EN COMUNICACIONES','INGENIERIAS'),(216,'INGENIERÍA EN COMUNICACIONES Y ELECTRÓNICA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(217,'INGENIERÍA EN ELECTRICIDAD','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(218,'INGENIERÍA EN ELECTRÓNICA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(219,'INGENIERÍA EN ELECTRÓNICA Y COMPUTACIÓN','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(220,'INGENIERIA EN GESTIÓN EMPRESARIAL','GESTION EMPRESARIAL'),(221,'INGENIERÍA EN NANOTECNOLOGÍA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(222,'INGENIERÍA EN NEGOCIOS','GESTION EMPRESARIAL'),(223,'INGENIERÍA EN OBRAS Y SERVICIOS','INGENIERIAS'),(224,'INGENIERÍA EN RECURSOS NATURALES Y AGROPECURIOS','AGRONOMIA'),(225,'INGENIERÍA EN SISTEMAS','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(226,'INGENIERÍA EN SISTEMAS DE PRODUCCIÓN','INGENIERIAS'),(227,'INGENIERÍA EN SISTEMAS PECUARIOS','AGRONOMIA'),(228,'INGENIERÍA EN TELEMÁTICA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(229,'INGENIERÍA EN VIDEOJUEGOS','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(230,'INGENIERIA EN ZOOTECNIA','CIENCIAS VETERINARIAS'),(231,'INGENIERÍA FORESTAL','INGENIERIAS'),(232,'INGENIERÍA GEOGRÁFICA','INGENIERIAS'),(233,'INGENIERÍA INDUSTRIAL','INGENIERIAS'),(234,'INGENIERÍA INFORMÁTICA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(235,'INGENIERÍA INFORMÁTICA EMPRESARIAL','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(236,'INGENIERÍA MECÁNICA','INGENIERIAS'),(237,'INGENIERÍA MECÁNICA ELÉCTRICA','INGENIERIAS'),(238,'INGENIERÍA MECATRÓNICA','INGENIERIAS'),(239,'INGENIERÍA QUÍMICA','INGENIERIAS'),(240,'INGENIERÍA SISTEMAS COMPUTACIONALES','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(241,'INGENIERÍA TOPOGRÁFICA','INGENIERIAS'),(242,'INGENIERÍA ZOOTECNIA','CIENCIAS VETERINARIAS'),(243,'INGENIERO AGRÓNOMO','AGRONOMIA'),(244,'INHALOTERAPIA','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(245,'INSTALACIONES ELÉCTRICAS','INGENIERIAS'),(246,'INTELIGENCÍA ARTIFICIAL','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(247,'INTERVENCIÓN CLÍNICA EN ADOLESCENTES','DISCIPLINAS CLINICAS'),(248,'INTERVENCIÓN CLÍNICA EN NIÑOS','DISCIPLINAS CLINICAS'),(249,'INVESTIGACIÓN DE MERCADOS','GESTION EMPRESARIAL'),(250,'KINESIOLOGÍA','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(251,'LABORATORISTA','CIENCIAS BASICAS'),(252,'LABORATORISTA CLÍNICO','DISCIPLINAS CLINICAS'),(253,'LENGUA','ESTUDIOS HISTORICOS Y HUMANOS'),(254,'LETRAS HISPÁNICAS','ESTUDIOS HISTORICOS Y HUMANOS'),(255,'LITERATURA ALEMANA','ESTUDIOS DE LA CULTURA'),(256,'LITERATURA HISPÁNICAS','ESTUDIOS DE LA CULTURA'),(257,'MANEJO DE APARATOS DE ELECTRODIAGNÓSTICO','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(258,'MANTENIMIENTO ELÉCTRICO','INGENIERIAS'),(259,'MANTENIMIENTO INDUSTRIAL','INGENIERIAS'),(260,'MÁQUINAS DE COMBUSTIÓN INTERNA','INGENIERIAS'),(261,'MARKETING','GESTION EMPRESARIAL'),(262,'MATEMÁTICAS','CIENCIAS BASICAS'),(263,'MECÁNICA AUTOMOTRIZ','INGENIERIAS'),(264,'MECÁNICA DIESEL','INGENIERIAS'),(265,'MEDICINA','DISCIPLINAS BASICAS'),(266,'MEDICINA VETERINARIA','CIENCIAS VETERINARIAS'),(267,'MÉDICO CIRUJANO','DISCIPLINAS CLINICAS'),(268,'MÉDICO PARTERO','DISCIPLINAS CLINICAS'),(269,'MERCADOTECNIA','GESTION EMPRESARIAL'),(270,'MERCADOTECNIA INTERNACIONAL','GESTION EMPRESARIAL'),(271,'MÚSICA','IMAGEN Y SONIDO'),(272,'NEGOCIOS INTERNACIONALES','GESTION EMPRESARIAL'),(273,'NEONATOLOGÍA','DISCIPLINAS CLINICAS'),(274,'NEUMOLOGÍA PEDIÁTRICA','DISCIPLINAS CLINICAS'),(275,'NEUROCIRUGÍA','DISCIPLINAS BASICAS'),(276,'NEUROLINGÜÍSTICA','DISCIPLINAS BASICAS'),(277,'NIVELACIÓN DE LA ENFERMERÍA','DISCIPLINAS CLINICAS'),(278,'NUTRICIÓN','DISCIPLINAS CLINICAS'),(279,'NUTRICIÓN HUMANA','DISCIPLINAS CLINICAS'),(280,'NUTRICIÓN PEDIÁTRICA','DISCIPLINAS CLINICAS'),(281,'OBSTETRICIA','DISCIPLINAS CLINICAS'),(282,'ODONTOLOGÍA','DISCIPLINAS CLINICAS'),(283,'ODONTOPEDIATRIA','DISCIPLINAS CLINICAS'),(284,'ÓPTICA','DISCIPLINAS BASICAS'),(285,'OPTOMETRÍA','DISCIPLINAS BASICAS'),(286,'ORGANIZACIÓN INDUSTRIAL','INGENIERIAS'),(287,'ORIENTACIÓN PSICOLÓGICA','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(288,'OTONEUROLOGÍA','DISCIPLINAS BASICAS'),(289,'OTORRINOLARINGOLOGÍA','DISCIPLINAS CLINICAS'),(290,'PEDAGOGÍA','CIENCIAS DE LA EDUCACION'),(291,'PEDIATRÍA','DISCIPLINAS CLINICAS'),(292,'PERICULTURA','DISCIPLINAS CLINICAS'),(293,'PERIODISMO','ESTUDIOS DE ESTADO Y SOCIEDAD'),(294,'PODOLOGÍA','DISCIPLINAS CLINICAS'),(295,'POLITÉCNICA','CIENCIAS BASICAS'),(296,'PROGRAMACIÓN DE VIDEOJUEGOS','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(297,'PROGRAMADOR ANALISTA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(298,'PROMOCIÓN DE LA SALUD','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(299,'PROTESISTA DENTAL','DISCIPLINAS CLINICAS'),(300,'PROTOCOLOS DE COMUNICACIÓN','INGENIERIAS'),(301,'PSICOANALÍSIS','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(302,'PSICOLOGÍA','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(303,'PSICOLOGÍA DE LA SALUD','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(304,'PSICOLOGÍA EDUCATIVA','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(305,'PSICOLOGÍA EN TERAPIA FAMILIAR','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(306,'PSICOLOGÍA SOCIAL','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(307,'PSICOONCOLOGIA','DISCIPLINAS CLINICAS'),(308,'PSICOPEDAGOGÍA','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(309,'PSICOTERAPIA','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(310,'PSICOTERAPIA BREVE SISTÉMICA','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(311,'PSICOTERAPIA INFANTIL','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(312,'PSICOTERAPIA PSICOANALÍTICA','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(313,'PUBLICIDAD','GESTION EMPRESARIAL'),(314,'PUERICULTURA','DISCIPLINAS CLINICAS'),(315,'QUÍMICA','CIENCIAS BASICAS'),(316,'QUÍMICA CLÍNICA','DISCIPLINAS CLINICAS'),(317,'QUÍMICA EN ALIMENTOS','CIENCIAS BASICAS'),(318,'QUÍMICA FARMACEÚTICA BIOLÓGICA','CIENCIAS BASICAS'),(319,'QUÍMICA Y FARMACIA','CIENCIAS BASICAS'),(320,'QUÍMICO BACTERIÓLOGO PARASITÓLOGO','CIENCIAS BASICAS'),(321,'QUÍMICO FARMACEÚTICO BIOLÓGICO','CIENCIAS BASICAS'),(322,'QUÍMICO FARMACÉUTICO INDUSTRIAL','CIENCIAS BASICAS'),(323,'QUÍMICO FARMACOBIÓLOGO','CIENCIAS BASICAS'),(324,'QUÍMICO INDUSTRIAL','CIENCIAS BASICAS'),(325,'QUIROPRÁCTICA','DISCIPLINAS CLINICAS'),(326,'RADIOLOGÍA','DISCIPLINAS CLINICAS'),(327,'RADIOLOGÍA E IMAGEN','DISCIPLINAS CLINICAS'),(328,'RECURSOS HUMANOS','GESTION EMPRESARIAL'),(329,'REDES DE COMUNICACIÓN','INGENIERIAS'),(330,'REHABILITACIÓN INTEGRAL','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(331,'RELACIONES COMERCIALES','GESTION EMPRESARIAL'),(332,'RELACIONES INTERNACIONALES','GESTION EMPRESARIAL'),(333,'REUMATOLOGÍA PEDIÁTRICA','DISCIPLINAS BASICAS'),(334,'ROBÓTICA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(335,'SALUD PÚBLICA','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(336,'SECRETARIA EJECUTIVA BILINGÜE','GESTION EMPRESARIAL'),(337,'SECRETARIADO','GESTION EMPRESARIAL'),(338,'SECRETARIADO BILINGÜE','GESTION EMPRESARIAL'),(339,'SECRETARIADO EN COMPUTACIÓN','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(340,'SISTEMA EDUCATIVO NACIONAL','CIENCIAS DE LA EDUCACION'),(341,'SISTEMA EN COMPUTACIÓN ADMINISTRATIVA','GESTION EMPRESARIAL'),(342,'SISTEMAS DE INFORMACIÓN','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(343,'SISTEMAS INFORMÁTICOS','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(344,'SOCIOLOGÍA','ESTUDIOS POLITICOS Y SOCIALES'),(345,'TÉCNICO RADIÓLOGO','DISCIPLINAS CLINICAS'),(346,'TECNOLOGÍA INFORMÁTICA','TECNOLOGIAS PARA LA INTEGRACION CIBER-HUMANA'),(347,'TERAPIA DE LENGUAJE','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(348,'TERAPIA FAMILIAR','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(349,'TERAPIA FÍSICA','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(350,'TERAPIA OCUPACIONAL','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(351,'TERAPIA RESPIRATORIA','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(352,'TERAPISTA EN COMUNICACIÓN HUMANA','DISCIPLINAS PARA EL DESARROLLO, PROMOCION Y PRESERVACION DE LA SALUD'),(353,'TRABAJO SOCIAL','ESTUDIOS POLITICOS Y SOCIALES'),(354,'TURISMO','GESTION EMPRESARIAL'),(355,'URBANISMO','IMAGEN Y SONIDO'),(356,'URBANÍSTICA Y MEDIO AMBIENTE','IMAGEN Y SONIDO'),(357,'URGENCIAS MÉDICAS BÁSICO','DISCIPLINAS CLINICAS'),(358,'UROLOGÍA GINECOLÓGICA','DISCIPLINAS CLINICAS'),(359,'VETERINARIA','CIENCIAS VETERINARIAS'),(360,'ZOOTECNIA','CIENCIAS VETERINARIAS');
...
BEGIN
    ...
    IF courseroom.fn_ExisteUsuario(_IdUsuario) = 1 THEN
        ...
        SELECT 1 AS "Codigo", 'Se Ha Actualizado La Configuración Del Usuario Satisfactoriamente' AS "Mensaje";
	...
	ELSE
        ...
        IF courseroom.fn_ExisteUsuario(_IdUsuario) = 1 THEN
            ...
            IF NOT EXISTS (SELECT CorreoElectronico FROM tb_usuarios WHERE IdUsuario <> _IdUsuario AND Activo = 1) THEN
                ...
                SELECT 1 AS "Codigo", 'Se Han Actualizado Los Datos De Autenticación Del Usuario Satisfactoriamente' AS "Mensaje";
	...
	IF _TipoUsuario = 'Estudiante' THEN
		...
		ELSE
			IF EXISTS (SELECT IdUsuario FROM tb_usuarios WHERE IdUsuario = _IdUsuario AND TipoUsuario = 'Estudiante') THEN
				...
				SELECT 1 AS "Codigo", 'Se ha Actualizado La Información Extra Del Usuario Satisfactoriamente' AS "Mensaje";
			ELSE
				SELECT -1 AS "Codigo", 'El Usuario No Se Encuentra Registrado' AS "Mensaje";
			END IF;
...
BEGIN
	...
	ELSE 
		...
		SELECT -1 AS "Codigo", 'Algún Usuario No Esta Disponible Para Chatear' AS "Mensaje";
...
BEGIN
	 IF courseroom.fn_ExisteUsuario(_IdUsuarioEmisor) = 1 THEN
		IF EXISTS(SELECT IdCurso FROM tb_cursos WHERE IdCurso = _IdCurso AND Activo = 1) THEN
			...
			SELECT LAST_INSERT_ID() AS "Codigo", 'Se Ha Agregado El Desempeño Del Usuario Satisfactoriamente' AS "Mensaje";
...
BEGIN
    ...
    IF EXISTS (SELECT IdUsuario FROM tb_usuarios WHERE IdUsuario = _IdUsuario AND TipoUsuario = 'Estudiante') THEN
        ...
        ELSE
            SELECT -1 AS "Codigo", 'El Interés No Se Encuentra Registrado' AS "Mensaje";
        END IF;
...
BEGIN
	...
	IF courseroom.fn_CampoValido(_Dispositivo) = 1 AND 
        ...
        IF courseroom.fn_ExisteUsuario(_IdUsuario) = 1 THEN
			...
			SELECT LAST_INSERT_ID() AS "Codigo", 'Se Ha Agregado La Sesión Correctamente' AS "Mensaje";
...
BEGIN
    ...
    IF EXISTS(SELECT IdTarea FROM tb_tareascursousuarios WHERE IdTarea = _IdTarea AND IdUsuario = _IdUsuario) THEN
            ...
            CALL sp_AgregarAviso(_IdUsuario,CONCAT('Tu Profesor Ha Calificado Tu Envió De La Tarea ',courseroom.fn_NombreTarea(_IdTarea)),'Tarea');
            
            SELECT 1 AS "Codigo", 'La Calificación Ha Sido Agregada A La Tarea Satisfactoriamente' AS "Mensaje";
...
BEGIN
	...
	IF courseroom.fn_ExisteUsuario(_IdUsuario) = 1 THEN 
		...
		ELSE
			SELECT -1 AS "Codigo", 'La Sesión No Se Encuentra Registrada' AS "Mensaje";
        END IF;
	ELSE
		SELECT -1 AS "Codigo", 'El Usuario No Se Encuentra Registrado' AS "Mensaje";
	END IF;
    ...
    IF EXISTS (SELECT IdCurso FROM tb_cursos WHERE IdCurso = _IdCurso AND Activo = 1) THEN
        ...
        IF EXISTS(SELECT IdTematica FROM tb_tematicas WHERE IdTematica = _IdTematica) THEN
            ...
            IF EXISTS (SELECT IdTematica FROM tb_tematicascursos WHERE IdTematica = _IdTematica AND IdCurso = _IdCurso) THEN
                ...
                SELECT 1 AS "Codigo", 'La Temática Ha Sido Desligada Del Curso Satisfactoriamente' AS "Mensaje";
